...
const DeletedTasks = ({ data, setData }) => {
  ...
  return (
    <div className="w-full h-1/2 mb-3 bg-[#0000004e] rounded-xl shadow-inner shadow-black p-3 overflow-y-scroll">
      <h1 className="text-white mb-2 px-3">Cancelled Tasks..</h1>
      {data.map(
        (task, index) =>
          task.deleted && (
            <div
